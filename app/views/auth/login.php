...
<body class="boxed-size bg-white">
            ...
            <div class="login-shell mx-auto">
                <div class="login-card mx-auto">
                    <!-- <div class="col-lg-6 d-none d-lg-block login-hero">
                            <img src="<?php echo defined('BASE_URL') ? BASE_URL : '/cpd_ac/public'; ?>/template/assets/images/login.jpg" alt="" aria-hidden="true">
                        </div> -->
                    <div class="col-lg-12">
                        <div class="login-form-wrap">
                            <div class="login-brand flex-column align-items-start">
                                <img src="<?php echo defined('BASE_URL') ? BASE_URL : '/cpd_ac/public'; ?>/assets/images/G_AM_logo-01.jpg" alt="CPDTH"
    ...
    <script src="<?php echo defined('BASE_URL') ? BASE_URL : '/cpd_ac/public'; ?>/template/assets/js/rangeslider.min.js"></script>
    <script src="<?php echo defined('BASE_URL') ? BASE_URL : '/cpd_ac/public'; ?>/template/assets/js/data-table.js"></script>
    <script src="<?php echo defined('BASE_URL') ? BASE_URL : '/cpd_ac/public'; ?>/template/assets/js/prism.js"></script>
    ...
    <script src="<?php echo defined('BASE_URL') ? BASE_URL : '/cpd_ac/public'; ?>/template/assets/js/apexcharts.min.js"></script>
    <script src="<?php echo defined('BASE_URL') ? BASE_URL : '/cpd_ac/public'; ?>/template/assets/js/echarts.js"></script>
    <script src="<?php echo defined('BASE_URL') ? BASE_URL : '/cpd_ac/public'; ?>/template/assets/js/swiper-bundle.min.js"></script>
    <script src="<?php echo defined('BASE_URL') ? BASE_URL : '/cpd_ac/public'; ?>/template/assets/js/fullcalendar.main.js"></script>
    <script src="<?php echo defined('BASE_URL') ? BASE_URL : '/cpd_ac/public'; ?>/template/assets/js/jsvectormap.min.js"></script>
    <script src="<?php echo defined('BASE_URL') ? BASE_URL : '/cpd_ac/public'; ?>/template/assets/js/world-merc.js"></script>
    <script src="<?php echo defined('BASE_URL') ? BASE_URL : '/cpd_ac/public'; ?>/template/assets/js/moment.min.js"></script>
    <script src="<?php echo defined('BASE_URL') ? BASE_URL : '/cpd_ac/public'; ?>/template/assets/js/lightpick.js"></script>
    <script src="<?php echo defined('BASE_URL') ? BASE_URL : '/cpd_ac/public'; ?>/template/assets/js/custom/custom.js"></script>
    <script src="<?php echo defined('BASE_URL') ? BASE_URL : '/cpd_ac/public'; ?>/template/assets/js/toastr.min.js"></script>
    <script src="<?php echo defined('BASE_URL') ? BASE_URL : '/cpd_ac/public'; ?>/template/assets/js/sweetalert2@11.js"></script>
    <script src="<?php echo defined('BASE_URL') ? BASE_URL : '/cpd_ac/public'; ?>/template/assets/js/loadingoverlay.js"></script>
    <script src="<?php echo defined('BASE_URL') ? BASE_URL : '/cpd_ac/public'; ?>/js/main.js"></script>
    ...
    <script>
        ...
        function Login() {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "<?php echo defined('BASE_URL') ? BASE_URL : '/cpd_ac/public'; ?>/auth/login",
                data: {
                    username: username,
                    password: password,
                },
