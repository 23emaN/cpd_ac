            ...
            <?php if (!empty($paginated_list)): ?>
                <?php foreach ($paginated_list as $index => $row): ?>
                    <tr class="closing-row"
                        data-customer-name="<?php echo htmlspecialchars($row['customer_name'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
                        data-user-id="<?php echo htmlspecialchars($row['user_id'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
                        data-user-name="<?php echo htmlspecialchars(trim(($row['user_firstname'] ?? '') . ' ' . ($row['user_lastname'] ?? '')), ENT_QUOTES, 'UTF-8'); ?>"
                        data-fiscal-date="<?php echo htmlspecialchars(!empty($row['fiscal_closing_date']) ? date('d/m/Y', strtotime($row['fiscal_closing_date'])) : '', ENT_QUOTES, 'UTF-8'); ?>"
                        data-doc-status="<?php echo htmlspecialchars($row['doc_status'] ?? '0', ENT_QUOTES, 'UTF-8'); ?>"
                        data-doc-date="<?php echo htmlspecialchars($row['doc_date'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
                        data-closing-status="<?php echo htmlspecialchars($row['closing_status'] ?? '0', ENT_QUOTES, 'UTF-8'); ?>"
                        data-closing-date="<?php echo htmlspecialchars($row['closing_date'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
                        data-audit-status="<?php echo htmlspecialchars($row['audit_status'] ?? '0', ENT_QUOTES, 'UTF-8'); ?>"
                        data-audit-date="<?php echo htmlspecialchars($row['audit_date'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
                        data-budget-refund-date="<?php echo htmlspecialchars($row['budget_refund_date'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
                        data-boj5-status="<?php echo htmlspecialchars($row['boj5_status'] ?? '0', ENT_QUOTES, 'UTF-8'); ?>"
                        data-boj5-date="<?php echo htmlspecialchars($row['boj5_date'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
