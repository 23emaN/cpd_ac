                            ...
                            <tbody>
                                <?php if (!empty($data['customers'])): ?>
                                    <?php foreach ($data['customers'] as $customer): ?>
                                        <tr>
                                            <td class="text-start">
                                                <div class="customer-name-title"><?php echo htmlspecialchars($customer['customer_name']); ?></div>
                                                <div class="customer-team-sub"><?php echo htmlspecialchars($customer['team_name'] ?: 'ยังไม่ระบุทีม'); ?></div>
                                            </td>
                                            <td class="text-center">
                                                <?php if ($customer['active_status'] == 1): ?>
                                                    <span class="badge-service-active">ใช้บริการอยู่</span>
                                                <?php else: ?>
                                                    <span class="badge-service-inactive">เลิกจ้าง</span>
                                                <?php endif; ?>
                                            </td>
