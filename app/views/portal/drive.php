...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $baseUrl; ?>/portal_assets/portal.css?v=<?php echo filemtime(__DIR__ . '/../../../public/portal_assets/portal.css'); ?>">
</head>
...
?>
    ...
    <script src="<?php echo $baseUrl; ?>/portal_assets/portal.js?v=<?php echo filemtime(__DIR__ . '/../../../public/portal_assets/portal.js'); ?>"
        data-api="<?php echo cd_e($baseUrl . '/portal/'); ?>"></script>
    <script src="<?php echo $baseUrl; ?>/portal_assets/drive-init.js?v=<?php echo filemtime(__DIR__ . '/../../../public/portal_assets/drive-init.js'); ?>"></script>
</body>
