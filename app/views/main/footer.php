...
<footer class="main-footer py-4 text-center mt-auto">
    <div class="container-fluid">
        <p class="mb-0 text-muted" style="font-size: 0.82rem; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
            &copy; <?= date('Y') ?> <strong class="text-dark">CPDTH</strong> Develop By : <span class="fw-semibold text-primary">Bigsara Company</span>
        </p>
    </div>
</footer>
...
<script src="/cpd_ac/public/template/assets/js/jquery.min.js"></script>
